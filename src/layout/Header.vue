<template>
  <header class="header">
    <a @click="openMenu" class="mobile-menu" href="#">
      <font-awesome-icon icon="bars"></font-awesome-icon>
    </a>
    <div class="nav-arrow">
      <a class="nav-arrow__item" href="#">
    ...
    <form class="search">
      <font-awesome-icon class="search__icon" icon="search"></font-awesome-icon>
      <input class="search__input" placeholder="搜尋" type="search" v-model="searchText" />
    </form>
    <div class="account">
      ...
      <transition name="fade">
        <div class="account__dropdown" v-if="accountDropdownMenuOpen">
          <a class="account__dropdown__item" href="#">私人工作階段</a>
